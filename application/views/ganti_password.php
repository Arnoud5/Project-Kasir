        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?php echo base_url();?>assets/img/Yus.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?=site_url('auth/ganti_password_process')?>"  >
                  <div class="form-group">
                   <label for="pass_baru">Password Baru</label>
                   <input id="pass_baru" type="password" class="form-control" name="pass_baru" tabindex="1"  autofocus>
                   <span style="color: red"><?=form_error('pass_baru')?></span>
                 </div>
                 ...
                 <div class="form-group">
                  <div class="d-block">
                    ...
                    <span style="color: red"><?=form_error('ulang_pass')?></span>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <a href="<?=site_url('Dashboard')?>" class="btn btn-danger btn-lg btn-block">
                    <i style="margin-right: 3px"></i>Cancel</a>
