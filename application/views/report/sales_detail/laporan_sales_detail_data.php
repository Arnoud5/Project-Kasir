<section class="section">
  ...
  <section class="content">
    ...
    <form method="POST" action="<?php echo base_url('report_sales_detail') ?>" style="text-align: center;">
  ...
  <div class="btn-group">
    <a class="btn btn-sm btn-info" target="_blank" href="<?php echo base_url().'report_sales_detail/pdf/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>"><i class="fas fa-file-pdf"></i> Export PDF</a>
  </div>


  <div class="btn-group">
    <a class="btn btn-sm btn-success"  href="<?php echo base_url().'report_sales_detail/excel/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>"><i class="fas fa-file-excel"></i> Export Excel</a>
  </div> 
